...
const translations: Record<string, Partial<Record<Language, string>>> = {
  ...
  'auth.signin_subtitle': { en: 'Sign in to Swasthya Setu', hi: 'स्वास्थ्य सेतु में साइन इन करें' },
  ...
  'auth.new_user': { en: 'New to Swasthya Setu?', hi: 'स्वास्थ्य सेतु पर नए हैं?' },
  'auth.create_account': { en: 'Create Account', hi: 'खाता बनाएं' },
  'auth.create_title': { en: 'Create Account', hi: 'नया खाता बनाएं' },
  'auth.join_subtitle': { en: 'Join Swasthya Setu today.', hi: 'आज ही स्वास्थ्य सेतु से जुड़ें।' },
  ...
  // App Tour
  'tour.welcome_title': { en: 'Welcome to Swasthya Setu', hi: 'स्वास्थ्य सेतु में आपका स्वागत है' },
  ...
  // Home Page
  'home.chat_title': { en: 'Chat with Swasthya Setu AI', hi: 'स्वास्थ्य सेतु AI से बात करें' },
